import '../top_playlists_screen/widgets/top_playlists_item_widget.dart';
                        ...
                        child: Obx(
                          () => ListView.builder(
                            ...
                            itemCount: controller.topPlaylistsModelObj.value
                                .topPlaylistsItemList.length,
                            itemBuilder: (context, index) {
                              TopPlaylistsItemModel model = controller
                                  .topPlaylistsModelObj
                                  .value
                                  .topPlaylistsItemList[index];
                              return TopPlaylistsItemWidget(
                                model,
                              );
                            },
                          ),
